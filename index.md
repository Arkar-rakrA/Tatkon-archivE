...
<div class="panoramic-container" style="position: relative; width: auto; margin-left: calc(-50vw + 50%); margin-right: calc(-50vw + 50%); margin-top: 50px; margin-bottom: 0px; overflow: hidden;">
  
  <img src="./assets/images/Tatkon-Sat-Image.png" alt="တပ်ကုန်းမြို့ မြင်ကွင်းကျယ်" style="width: 100%; height: auto; display: block; object-fit: contain; opacity: 0.85;">

  <div style="position: absolute; bottom: 15px; left: 0; width: 100%; text-align: center; color: #ffffff; font-size: 13px; text-shadow: 1px 1px 4px rgba(0,0,0,0.8); z-index: 10;">
